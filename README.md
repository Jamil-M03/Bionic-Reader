...
- 🟦 **Chrome**: Chrome Web Store (Working on publishing) <!-- [Chrome Web Store](https://chromewebstore.google.com/detail/YOUR_EXTENSION_ID) --> <!-- fill the real ID once the listing is approved -->
